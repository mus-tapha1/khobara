...
document.addEventListener('DOMContentLoaded', function() {
    ...
    waBtn.style.cssText = 'position:fixed;bottom:90px;left:30px;width:55px;height:55px;border-radius:50%;background:#25D366;color:white;display:flex;align-items:center;justify-content:center;z-index:1000;text-decoration:none;box-shadow:0 4px 15px rgba(37,211,102,0.5);transition:all 0.3s ease;';
